...
\begin{description}
	\item[Contoh \thesection.1]  Mencetak teks ke layar.
	...
	\end{itemize}
	\item [Contoh \thesection.2] Mencetak integer.
	...
	\item[Contoh \thesection.3] Keluaran bilangan real (float atau double)
...
\begin{description}
	\item  [Contoh \thesection.4] Menghitung luas segitiga dengan  dengan alas \verb*|Alas|   dan tinggi \verb*|Tinggi| yang diinputkan dari keyboard. 
...
\end{description}
	...
	\item[Contoh \thesection.5] Program untuk memasukkan nama dan email.\\
...
\begin{description}
	\item[Contoh \thesection.6] Mengubah baris dengan escape sequence \verb*|\n|.
	\begin{lstlisting}
#include <stdio.h>
...
\item[Contoh \thesection.7] Menggunakan escape sequence \verb*|\t| mengubah tab.
\begin{lstlisting}[language=c]
#include <stdio.h>
int main(void)
{
